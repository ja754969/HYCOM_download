...
%% /Hindcast Data: Feb-01-2017 to May-31-2017/All (uv3z) Data
firstdate = datenum('2000010100','yyyymmddHH');
fn_i = ['https://tds.hycom.org/thredds/dodsC/GLBv0.08/expt_92.8/uv3z?lat[0:1:3250],lon[0:1:4499],time[0:1:0]'];  
first_date_download = datetime('2017/02/01 00:00:00','InputFormat','yyyy/MM/dd HH:mm:ss');
end_date_download = datetime('2017/05/31 21:00:00','InputFormat','yyyy/MM/dd HH:mm:ss');
%%
loop_count = 0;
while loop_count == 0
    try
...
while t <= end_index
    ...
    fn = ['https://tds.hycom.org/thredds/dodsC/GLBv0.08/expt_92.8?lat[' ...
    ...
    try
        ...
        saving_folder = 'E:/Data/HYCOM/HYCOM_GLBv_surface_uv/expt_928';
        mkdir(saving_folder)
