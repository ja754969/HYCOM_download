...
%% 2018/09/19 12:00:00 ~ 2018/12/08 21:00:00
firstdate = datenum('2000010100','yyyymmddHH');
fn_i = ['https://tds.hycom.org/thredds/dodsC/GLBu0.08/expt_93.0/uv3z?lat[0:1:2000],lon[0:1:4499],time[0:1:0]'];  
first_date_download = datetime('2018/09/19 12:00:00','InputFormat','yyyy/MM/dd HH:mm:ss');
end_date_download = datetime('2018/12/08 21:00:00','InputFormat','yyyy/MM/dd HH:mm:ss');
%%
loop_count = 0;
while loop_count == 0
    try
...
while t <= end_index
    ...
    fn = ['https://tds.hycom.org/thredds/dodsC/GLBu0.08/expt_93.0/uv3z?lat[' ...
    ...
    try
        ...
        saving_folder = 'E:/Data/HYCOM/HYCOM_GLBu_surface_uv/expt_930';
        mkdir(saving_folder)
