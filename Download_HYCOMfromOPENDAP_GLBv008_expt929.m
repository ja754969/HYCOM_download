...
%% 2017/10/01 12:00:00 ~ 2017/12/31 21:00:00
firstdate = datenum('2000010100','yyyymmddHH');
fn_i = ['https://tds.hycom.org/thredds/dodsC/GLBv0.08/expt_92.9/uv3z?lat[0:1:3250],lon[0:1:4499],time[0:1:0]'];  
first_date_download = datetime('2017/10/01 12:00:00','InputFormat','yyyy/MM/dd HH:mm:ss');
end_date_download = datetime('2017/12/31 21:00:00','InputFormat','yyyy/MM/dd HH:mm:ss');
%%
loop_count = 0;
while loop_count == 0
    try
...
while t <= end_index
    ...
    fn = ['https://tds.hycom.org/thredds/dodsC/GLBv0.08/expt_92.9/uv3z?lat[' ...
    ...
    try
        ...
        saving_folder = 'E:/Data/HYCOM/HYCOM_GLBv_surface_uv/expt_929';
        mkdir(saving_folder)
